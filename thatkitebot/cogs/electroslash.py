...
#
#         args_parsed = dict(
#             c1=util.Parsing.slash_command_arguments_parser(c1),
#             r1=util.Parsing.slash_command_arguments_parser(r1),
#             fcut=util.Parsing.slash_command_arguments_parser(fcut)
#         )
#         try:
#             if draw_plot:
