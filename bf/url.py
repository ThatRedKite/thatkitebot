...
def xml_sequence_parse(payload:dict,sourceurl:str,attr:str,updatevalue:str, islist:bool=False):
...
def monosodiumglutamate(payload:dict, updatevalue:str):
